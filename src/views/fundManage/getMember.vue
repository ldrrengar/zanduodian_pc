        ...
        <el-main class="el-box">
          <div class="el-flex el-box-column ">
            <el-table :data="tableData" ref="tableData" style="width: 100%; overflow: auto;" border stripe>
              ...
              <el-table-column show-overflow-tooltip sortable min-width="120" align="center" prop="created" label="充值账号">
              </el-table-column>
              <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="tasks_id" label="会员id"></el-table-column>
              <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="money" label="充值金额"></el-table-column>
              <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="add_time" label="充值时间"></el-table-column>
            </el-table>
            <!-- 分页表格 -->
...
export default {
  ...
  methods: {
    // 总用户数获取事件
    getLists() {
      this.$http.get('/api/transfer_look/?page='+ this.currentPage + '&page_size=' + this.pageSize + '&type=' + this.$route.query.fundType+ '&member=True').then(res => {
        console.log(res)
