            ...
            <el-tab-pane :label="totalNum1" name="first" class="el-card-flex">
              <div class="el-flex el-box-column ">
                <el-table :data="tableData" ref="tableData" style="width: 100%;" border stripe>
                  ...
                  <el-table-column show-overflow-tooltip sortable min-width="120" prop="state" align="center" label="是否会员"></el-table-column>
...
export default {
  ...
  created() {
    this.getLists()
    this.getLists1()
    this.totalNum1 = '已完成数量: ' + this.totalTask
    this.totalNum2 = '今日完成数量: ' + this.toDayTask
  },
  methods: {
    // 总用户数获取事件
    getLists() {
