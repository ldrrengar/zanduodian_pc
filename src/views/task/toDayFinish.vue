            ...
            <el-tab-pane :label="totalNum1" name="first" class="el-card-flex">
              <div class="el-flex el-box-column ">
                <el-table :data="tableData" ref="tableData" style="width: 100%;" border stripe>
                  ...
                  <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="money" label="发布金额"></el-table-column>
                  <el-table-column show-overflow-tooltip sortable min-width="120" prop="state" align="center" label="佣金"></el-table-column>
                  <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="time" label="完成日期"></el-table-column>
                  <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="time" label="完成人账号"></el-table-column>
                  <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="time" label="完成人昵称"></el-table-column>
                </el-table>
                <!-- 分页表格 -->
...
export default {
  ...
  created() {
    this.getLists()
    this.getLists1()
    this.totalNum1 = '会员完成数量: ' + this.totalTask
    this.totalNum2 = '非会员完成数量: ' + this.toDayTask
  },
  methods: {
    // 总用户数获取事件
    getLists() {
