  ...
  <div class="app-container">
    <div class="filter-container">
      <el-table :data="tableData" ref="tableData" style="width: 100%" border stripe>
        ...
        <el-table-column show-overflow-tooltip sortable min-width="100" align="center" prop="execute_id" label="执行编号"></el-table-column>
        ...
        <el-table-column show-overflow-tooltip sortable min-width="80" align="center" prop="price" label="佣金"></el-table-column>
        <el-table-column show-overflow-tooltip sortable min-width="100" align="center" prop="tasks_name" label="要求"></el-table-column>
        <el-table-column show-overflow-tooltip sortable min-width="120" prop="complete_user" align="center" label="完成人"></el-table-column>
        <el-table-column show-overflow-tooltip sortable min-width="120" prop="state" align="center" label="状态"></el-table-column>
        <el-table-column show-overflow-tooltip sortable min-width="200" prop="image" align="center" label="任务截图">
      ...
      <el-dialog title="审批" :visible.sync="dialogFormVisible">
        <el-form :model="form" ref="form">
          ...
          <el-form-item v-show="isPass" prop="member" label="确定提交？" :label-width="formLabelWidth">
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const { data: res } = await this.$http.get('/api/check_complete_tasks/', data)
      console.log(res)
    ...
    submit() {
      if (this.isPass) { // 通过
        ...
        const { data: res } = this.$http.patch(`/api/complete_tasks/${this.rowData.execute_id }/`, data)
      } else { // 驳回
        console.log(this.form)
        console.log(this.rowData)
        let data = {
